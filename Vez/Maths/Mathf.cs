...
namespace Vez.Maths
{
    public static class Mathf
    {
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector2 RotateAround(float totalTime, Vector2 position, float speed)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector2 Lissajou(float totalTime, float xFrequency = 2f, float yFrequency = 3f, float xMagnitude = 1,
                                       float yMagnitude = 1, float phase = 0)
        {
            var x = Sin(totalTime * xFrequency + phase) * xMagnitude;
            var y = Cos(totalTime * yFrequency) * yMagnitude;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector2 LissajouDamped(float totalTime, float xFrequency = 2f, float yFrequency = 3f, float xMagnitude = 1,
                                             float yMagnitude = 1, float phase = 0.5f, float damping = 0f,
                                             float oscillationInterval = 5f)
        {
            var wrappedTime = PingPong(totalTime, oscillationInterval);
            var damped = Pow(MathHelper.E, -damping * wrappedTime);

            var x = damped * Sin(totalTime * xFrequency + phase) * xMagnitude;
            var y = damped * Cos(totalTime * yFrequency) * yMagnitude;
