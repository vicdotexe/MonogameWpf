...
using Vez.Utils.Tweens.Easing;
using Vez.Utils.Tweens.Interfaces;

namespace Vez.Utils.Tweens
{
    public class TweenManager : GlobalManager
	{
		...
		public override void Update()
		{
			...
			for (var i = _activeTweens.Length - 1; i >= 0; --i)
			{
				...
				if (tween.Tick(_time.DeltaTime, _time.UnscaledDeltaTime))
