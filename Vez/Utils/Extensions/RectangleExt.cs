...
namespace Vez.Utils.Extensions
{
    public static class RectangleExt
	{
		...
		public static void ExpandSide(ref Rectangle rect, Edge edge, int amount)
		{
			...
			amount = global::System.Math.Abs(amount);
		...
		{
			result.X = global::System.Math.Min(value1.X, value2.X);
			result.Y = global::System.Math.Min(value1.Y, value2.Y);
			result.Width = global::System.Math.Max(value1.Right, value2.Right) - result.X;
			result.Height = global::System.Math.Max(value1.Bottom, value2.Bottom) - result.Y;
		}
		...
		public static bool RayIntersects(ref Rectangle rect, ref Ray2D ray, out float distance)
		{
			...
			if (global::System.Math.Abs(ray.Direction.X) < 1E-06f)
			{
			...
			if (global::System.Math.Abs(ray.Direction.Y) < 1E-06f)
			{
		...
		public static bool CollisionCheck(ref Rectangle rect, ref Rectangle other, out float moveX, out float moveY)
		{
			...
			moveX = global::System.Math.Abs(l) < r ? l : r;
			moveY = global::System.Math.Abs(t) < b ? t : b;

			// only use whichever offset is the smallest
			if (global::System.Math.Abs(moveX) < global::System.Math.Abs(moveY))
				moveY = 0.0f;
			else
				moveX = 0.0f;
		...
		public static Vector2 GetIntersectionDepth(ref Rectangle rectA, ref Rectangle rectB)
		{
			...
			if (global::System.Math.Abs(distanceX) >= minDistanceX || global::System.Math.Abs(distanceY) >= minDistanceY)
				return Vector2.Zero;
		...
		public static Vector2 GetClosestPointOnBoundsToOrigin(ref Rectangle rect)
		{
			...
			var minDist = global::System.Math.Abs(rect.Location.X);
			var boundsPoint = new Vector2(rect.Location.X, 0);

			if (global::System.Math.Abs(max.X) < minDist)
			{
				minDist = global::System.Math.Abs(max.X);
				boundsPoint.X = max.X;
				boundsPoint.Y = 0f;
			}

			if (global::System.Math.Abs(max.Y) < minDist)
			{
				minDist = global::System.Math.Abs(max.Y);
				boundsPoint.X = 0f;
				boundsPoint.Y = max.Y;
			}

			if (global::System.Math.Abs(rect.Location.Y) < minDist)
			{
				minDist = global::System.Math.Abs(rect.Location.Y);
				boundsPoint.X = 0;
