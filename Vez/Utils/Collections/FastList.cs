...
namespace Vez.Utils.Collections
{
	/// <summary>
	...
	public class FastList<T>
	{
		...
		public void Add(T item)
		{
			if (Length == Buffer.Length)
				Array.Resize(ref Buffer, global::System.Math.Max(Buffer.Length << 1, 10));
			Buffer[Length++] = item;
		}
		...
		public void EnsureCapacity(int additionalItemCount = 1)
		{
			if (Length + additionalItemCount >= Buffer.Length)
				Array.Resize(ref Buffer, global::System.Math.Max(Buffer.Length << 1, Length + additionalItemCount));
		}
